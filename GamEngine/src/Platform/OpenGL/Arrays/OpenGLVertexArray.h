...
namespace GamEngine {
	...
	public:
		...
		inline virtual const std::vector<std::shared_ptr<VertexBuffer>>& get_vertex_buffers() const override { return m_vertex_buffers; };
		inline virtual const std::shared_ptr<IndexBuffer>& get_index_buffer() const override { return m_index_buffer; }
	private:
